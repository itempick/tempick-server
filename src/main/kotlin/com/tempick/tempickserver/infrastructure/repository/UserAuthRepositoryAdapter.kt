...
class UserAuthRepositoryAdapter(
    ...
    override fun findActiveByEmail(loginId: String): UserAuth? = jpa.findActiveByEmail(loginId)
    override fun existsByEmail(loginId: String): Boolean = jpa.existsByEmail(loginId)
